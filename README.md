...
## מבוא
תיעוד זה מספק את ההוראות וההסברים הנחוצים למפתחים להקים ולהפעיל מופע מקומי של אפליקציית ניהול מטלות שנבנתה באמצעות Node.js עם Express. הקוד מגדיר API ליצירה, רישום ומחיקת מטלות, יחד עם ממשק קדמי פשוט לאינטראקציה עם המערכת.

## דרישות מערכת
- Node.js מותקן על המכונה המקומית.
